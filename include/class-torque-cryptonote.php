...
require_once('class-torque-base58.php');

class Torque_Cryptonote
{
    protected $ed25519;
    public function __construct()
    {
        $this->ed25519 = new ed25519();
        $this->base58 = new Torque_base58();
        $this->address_prefix = TORQUE_GATEWAY_ADDRESS_PREFIX;
        $this->address_prefix_integrated = TORQUE_GATEWAY_ADDRESS_PREFIX_INTEGRATED;
    }
    ...
    /*
     * Create a valid base58 encoded Torque address from public keys
     *
     * @param string Public spend key
     * @param string Public view key
     *
     * @return string Base58 encoded Torque address
     */
...
/*
 * Decode a base58 encoded Torque address
 *
 * @param string A base58 encoded Torque address
 *
 ...
 */
    ...
    /*
     * Generate a Torque address from seed
     *
     * @param string Hex string to use as seed
     *
     * @return string A base58 encoded Torque address
     */
