...
class Torque_Explorer_Tools
{
    private $url;
    public function __construct($testnet = false)
    {
        $this->url = $testnet ? TORQUE_GATEWAY_TESTNET_EXPLORER_URL : TORQUE_GATEWAY_MAINNET_EXPLORER_URL;
    }
